...
class IQ_Option:
    ...
    def actualizar_todos_los_codigos(self):
        ...
        assets_dict = ast.literal_eval(raw_data)
        sorted_assets = dict(sorted(assets_dict.items(), key=lambda x: x[1]))

        for asset, code in sorted_assets.items():
            print(f"'{asset}': {code},")
